    ...
    public class TestDatabaseFixture
    {
        ...
        public void clearTables(BookShelfContext _bookShelfContext)
        {
            while (!cleared)
            {
				...
				_bookShelfContext.Database.ExecuteSql($"TRUNCATE TABLE [dbo].[review]");
                ...
                if(
                    _bookShelfContext.Book.Count() == 0 &&
					_bookShelfContext.User.Count() == 0 &&
					_bookShelfContext.Genre.Count() == 0 &&
					_bookShelfContext.Author.Count() == 0 &&
					_bookShelfContext.Book_Author.Count() == 0 &&
					_bookShelfContext.Book_Genre.Count() == 0 &&
					_bookShelfContext.User_Book.Count() == 0 &&
					_bookShelfContext.Review.Count() == 0
                    )
                {
                    cleared = true;
                }
        ...
        public void populateBridgeTables(BookShelfContext _bookShelfContext)
        {
			...
			_bookShelfContext.Database.ExecuteSql(
                ...
                INSERT INTO [dbo].[review]
                    ...
                    [DATE_SUBMITTED])
                VALUES
                    (0, 0, 'review 0', 2, '2014-01-02'),
                    (1, 1, 'review 1', 4, '2014-01-03'),
                    (2, 2, 'review 2', 1, '2014-01-04'),
                    (3, 3, 'review 3', 7, '2014-01-05'),
                    (4, 3, 'review 4', 4, '2014-01-06'),
                    (1, 2, 'review 5', 9, '2014-01-07'),
                    (4, 1, 'review 6', 3, '2014-01-08'),
                    (2, 0, 'review 7', 10, '2014-01-09'),
                    (3, 2, 'review 8', 2, '2014-01-12'),
                    (1, 3, 'review 9', 6, '2014-01-18'),
                    (3, 1, 'review 10', 10, '2014-01-13'),
                    (1, 0, 'review 11', 5, '2014-01-14'),
                    (2, 1, 'review 12', 9, '2014-01-15'),
                    (4, 2, 'review 13', 5, '2014-01-16'),
                    (0, 2, 'review 14', 3, '2014-01-17')"
                    );
            }
		}
    }
